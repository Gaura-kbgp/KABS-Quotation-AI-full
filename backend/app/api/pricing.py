...
WELLBORN_STRUCTURE = {
    ...
    # Col C — PREMIUM CHERRY (CHERRY/DFO CHERRY) + ELITE MAPLE (CANYON/DURANGO/ELDERIDGE MAPLE)
    # ABILENE/BELCOURT/CLAYTON/LUBBOCK MAPLE are PREMIUM MAPLE → col D
    "PREMIUM CHERRY / PREMIUM DURAFORM (TEXTURED) / ELITE MAPLE / ELITE PAINTED": [
        ...
        "CANYON MAPLE", "CANYON DFO MAPLE",
        "CLAYTON CHERRY", "CLAYTON DFO CHERRY",
        "DURANGO MAPLE", "ELDERIDGE MAPLE",
        "LUBBOCK CHERRY", "LUBBOCK DURAFORM (NON-TEXTURED)",
        "OXRIDGE MAPLE", "OXRIDGE DFO MAPLE",
    ],
    # Col D — PREMIUM MAPLE, PAINTED, DURAFORM (NON-TEXTURED)
    "PRIME CHERRY / PREMIUM MAPLE / PREMIUM PAINTED / PREMIUM DURAFORM (NON-TEXTURED)": [
        "ABILENE CHERRY", "ABILENE MAPLE", "ABILENE PAINTED",
        "ABILENE DFO CHERRY", "ABILENE DFO MAPLE", "ABILENE DFO PAINTED",
        "BELCOURT MAPLE", "BELCOURT PAINTED", "BELCOURT DFO MAPLE", "BELCOURT DFO PAINTED",
        "CLAYTON MAPLE", "CLAYTON PAINTED", "CLAYTON DFO MAPLE", "CLAYTON DFO PAINTED",
        "DENVER CHERRY", "DENVER MAPLE", "DENVER DFO CHERRY", "DENVER DFO MAPLE",
        "LUBBOCK DURAFORM (NON-TEXTURED)", "LUBBOCK MAPLE", "LUBBOCK PAINTED",
        "OXRIDGE MAPLE", "OXRIDGE PAINTED", "OXRIDGE DFO MAPLE", "OXRIDGE DFO PAINTED",
    ],
    # Col E
    ...
    "CHOICE DURAFORM / CHOICE MAPLE / CHOICE PAINTED": [
        "BARREN MAPLE", "BARREN DURAFORM", "BARREN PAINTED",
        "CARSON DURAFORM", "CARSON PAINTED", "CARSON DFO DURAFORM", "CARSON DFO PAINTED",
    ],
    # Col G
