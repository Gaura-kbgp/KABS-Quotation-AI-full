...
2. **Fix Formatting**: Ensure all SKU codes are fully uppercase, and have all spaces and special characters removed (e.g. "W3042 BUTT" -> "W3042BUTT").
   **Strip parenthetical annotations**: If a code still contains annotation text that was merged in error, strip it.
   Examples: "UF3DW" → "UF3", "UF642DWR" → "UF642", "CROWNVAROPTS" → "CROWN", "LIGHTRAILVAROPTS" → "LIGHTRAIL", "BACKB48VENTBOX" → "BACKB48", "QM8TRIMCEILING" → "QM8", "HWC1X2X94CROWNCLEAT" → "HWC1X2X94", "HWC2X4X96DW" → "HWC2X4X96", "FL48VOIDS" → "FL48".
